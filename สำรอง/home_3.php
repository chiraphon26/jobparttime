        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <table id="question" border="1">
                                ...
                                <tbody>
                                 ...
                                 <tr>
                                    <td>6</td>
                                    <td>โรงเรียนกวดวิชา/ค่ายกวดวิชา</td>
                                ...
                                <tr>
                                    ...
                                    <td>9</td>
                                    <td>งานสำนักทะเบียน/งานหอสมุด/งานกองกิจ</td>
                            ...
                            <td>11</td>
                            <td>ร้านค้าสะดวกซื้อ</td>
                            <td><input type="radio"  name="choice11" /></td>
                            <td><input type="radio"  name="choice11" /></td>
                            <td><input type="radio"  name="choice11" /></td>
                            <td><input type="radio"  name="choice11" /></td>
                            <td><input type="radio"  name="choice11" /></td>
                    ...
                    <td>12</td>
                    <td>ปั้มน้ำมัน</td>
                    <td><input type="radio"  name="choice12" /></td>
                    <td><input type="radio"  name="choice12" /></td>
                    <td><input type="radio"  name="choice12" /></td>
                    <td><input type="radio"  name="choice12" /></td>
                    <td><input type="radio"  name="choice12" /></td>
