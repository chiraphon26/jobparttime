...
<div style="clear:both; margin-top:20px;" class="center">
    <button type="button" onclick="location.href='clickApprove.php?member_username=<?php echo $row[" member_username"] ?> Approve</button>
    <button type="button" onclick="location.href='clickDisapprove.php?member_username=<?php echo $row["member_username"] ?> Disapprove</button>
</div>
