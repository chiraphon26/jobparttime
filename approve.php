    ...
    <nav id="menu" class="navbar container" style="background-color:#AEE0A4;">
        <div class="collapse navbar-collapse navbar-ex1-collapse">
            <ul class="nav navbar-nav float-left">
                ...
                <li>
                    <a class="btn btn-secondary dropdown-toggle" onclick="location.href='index.php'" role="button" id="dropdownMenuLink"
                ...
                <li>
                    <a class="btn btn-secondary dropdown-toggle" onclick="location.href='manageuser.php'" role="button"
            ...
            <div class="row">
                <div id="main-content" class="col-md-12">
                    <div class="box" style="padding-bottom:50px;">
                        ...
                        <p>Birthday :
                            <?php echo DateThai($row["Birthdate"]); ?>
                        </p><br>
                        <p>E-mail :
                            <?php echo $row["Email"]; ?>
                        </p><br>
                        ...
                        <div style="clear:both;">
                            <!---put img---->
                            <img src="<?php echo " SSN_img/".$row["FileSSN"].".jpg"; ?>" width="500px" height="400px"
                            class="center">
                        </div>
                        <div style="clear:both; margin-top:20px;" class="center">
                            <button type="button" onclick="location.href='clickApprove.php?username=<?php echo $row["
                                Username"]."&email=".$row[" email"]; ?>';" class="btn btn-default"
                                style="background-color:#AEE0A4; color:white; font-size:18px;">Approve</button>
                            <button type="button" onclick="location.href='clickDisapprove.php?username=<?php echo $row["
                                Username"]."&email=".$row[" email"]; ?>';" class="btn btn-default"
                                style="background-color:#AEE0A4; color:white; font-size:18px;">Disapprove</button>
                        </div>
